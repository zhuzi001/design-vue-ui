  ...
  data () {
    return {
      form: {
        ...
        basicValueObj: undefined,
        basicValueArr12: [],
        optionLabelProp1: undefined,
        optionLabelProp2: undefined,
        optionLabelProp3: undefined,
        pagination1: undefined,
        pagination2: undefined,
        loadValue: undefined
      },
      inputValue1: '',
      rules: {
  ...
  methods: {
    ...
    async queryData (param, isPag) {
      ...
      const _all = inputValue
        ? allRegion.filter((v) => v.name.indexOf(inputValue) !== -1)
        : allRegion
